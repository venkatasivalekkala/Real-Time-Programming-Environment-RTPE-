var FirepadUserList = (function() {
  ...
  FirepadUserList.prototype.makeUserEntryForSelf_ = function() {
    ...
    var nameInput = elt('input', null, { readonly:'enable' , type: 'text', 'class': 'firepad-userlist-name-input'} );
    nameInput.value = this.displayName_;

    var nameHint = elt('div', 'YOUR NAME', { 'class': 'firepad-userlist-name-hint'} );
